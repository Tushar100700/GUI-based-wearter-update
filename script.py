# Create a comprehensive GUI weather application with multiple features
...
# Weather application code with modern GUI
weather_app_code = '''
import tkinter as tk
...
print("✅ Modern Weather App code created successfully!")
print("\n🔧 Features included:")
print("• Modern dark theme GUI with tabs")
print("• Current weather with weather icons")
print("• 5-day weather forecast")
print("• Interactive temperature and humidity charts")
print("• Real-time data from OpenWeatherMap API")
print("• Threading for non-blocking API calls")
print("• Error handling and status updates")
print("• Responsive design with scrollable forecast")

# Save the code to a file
with open('modern_weather_app.py', 'w') as f:
    f.write(weather_app_code)

print("\n📁 Code saved to: modern_weather_app.py")